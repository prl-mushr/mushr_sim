...
class FakeURGNode:
    ...
    def timer_cb(self, event):
        ...
        range_pose = np.array((laser_pose.pose.position.x, laser_pose.pose.position.y,
                               utils.quaternion_to_angle(laser_pose.pose.orientation)), dtype=np.float32).reshape(1, 3)
        ...
        self.br.sendTransform((range_pose[0,0], range_pose[0,1], 0.0),
